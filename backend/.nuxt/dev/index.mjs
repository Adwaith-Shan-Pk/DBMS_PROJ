...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/@vue/shared/dist/shared.cjs.js';
import mysql from 'file://E:/Coding/DBMS_Proj/backend/node_modules/mysql2/promise.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/Coding/DBMS_Proj/backend/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/youch-core/build/index.js';
import { Youch } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://E:/Coding/DBMS_Proj/backend/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://E:/Coding/DBMS_Proj/backend/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"E:/Coding/DBMS_Proj/backend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/Coding/DBMS_Proj/backend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:/Coding/DBMS_Proj/backend/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/Coding/DBMS_Proj/backend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:/Coding/DBMS_Proj/backend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:/Coding/DBMS_Proj/backend/.data/kv"}));
...
const rootDir = "E:/Coding/DBMS_Proj/backend";
...
const _EeCBolpU7A0xoHuAvjzaAok2blwacZwKm8wJ6MV004 = (nitroApp) => {
...
const plugins = [
  _EeCBolpU7A0xoHuAvjzaAok2blwacZwKm8wJ6MV004,
...
const __H8KYU = eventHandler((event) => {
...
const _KvMSY_ = defineEventHandler((event) => {
  const config = useRuntimeConfig();
...
const getServerEntry = () => import('file://E:/Coding/DBMS_Proj/backend/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file://E:/Coding/DBMS_Proj/backend/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _lazy_g9Cu27 = () => Promise.resolve().then(function () { return _id__delete$b; });
const _lazy_8zPGWs = () => Promise.resolve().then(function () { return _id__put$b; });
const _lazy_pMllFg = () => Promise.resolve().then(function () { return index_get$b; });
const _lazy_M84cHO = () => Promise.resolve().then(function () { return index_post$b; });
const _lazy_muUGYy = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_nfBp8J = () => Promise.resolve().then(function () { return logout_post$1; });
const _lazy_KozKPw = () => Promise.resolve().then(function () { return _id__delete$9; });
const _lazy_FSvTsU = () => Promise.resolve().then(function () { return _id__get$9; });
const _lazy_W5I8nD = () => Promise.resolve().then(function () { return _id__put$9; });
const _lazy_ZVGq17 = () => Promise.resolve().then(function () { return index_get$9; });
const _lazy_BZDfmi = () => Promise.resolve().then(function () { return index_post$9; });
const _lazy_XwVgX7 = () => Promise.resolve().then(function () { return dashboard_get$1; });
const _lazy_A82byK = () => Promise.resolve().then(function () { return _id__delete$7; });
const _lazy_Xu49Up = () => Promise.resolve().then(function () { return _id__get$7; });
const _lazy_A5Q2pL = () => Promise.resolve().then(function () { return _id__put$7; });
const _lazy_6eoUUH = () => Promise.resolve().then(function () { return index_get$7; });
const _lazy_xQOUCs = () => Promise.resolve().then(function () { return index_post$7; });
const _lazy_tLa308 = () => Promise.resolve().then(function () { return _id__delete$5; });
const _lazy_zH3jfg = () => Promise.resolve().then(function () { return _id__get$5; });
const _lazy_0pov96 = () => Promise.resolve().then(function () { return _id__put$5; });
const _lazy_fyGeCP = () => Promise.resolve().then(function () { return index_get$5; });
const _lazy_MpbSxJ = () => Promise.resolve().then(function () { return index_post$5; });
const _lazy_DWBXI3 = () => Promise.resolve().then(function () { return _id__delete$3; });
const _lazy_fLL10b = () => Promise.resolve().then(function () { return _id__get$3; });
const _lazy_yKvwA6 = () => Promise.resolve().then(function () { return _id__put$3; });
const _lazy_pnLjai = () => Promise.resolve().then(function () { return index_get$3; });
const _lazy_1mZF5P = () => Promise.resolve().then(function () { return index_post$3; });
const _lazy_sJODlQ = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_NRtoGq = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_AOEVW3 = () => Promise.resolve().then(function () { return _id__put$1; });
const _lazy_prLOUD = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_BjXgQf = () => Promise.resolve().then(function () { return index_post$1; });
const _lazy_xfiAXG = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: __H8KYU, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _KvMSY_, lazy: false, middleware: true, method: undefined },
  { route: '/api/admins/:id', handler: _lazy_g9Cu27, lazy: true, middleware: false, method: "delete" },
  { route: '/api/admins/:id', handler: _lazy_8zPGWs, lazy: true, middleware: false, method: "put" },
  { route: '/api/admins', handler: _lazy_pMllFg, lazy: true, middleware: false, method: "get" },
  { route: '/api/admins', handler: _lazy_M84cHO, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/login', handler: _lazy_muUGYy, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_nfBp8J, lazy: true, middleware: false, method: "post" },
  { route: '/api/customers/:id', handler: _lazy_KozKPw, lazy: true, middleware: false, method: "delete" },
  { route: '/api/customers/:id', handler: _lazy_FSvTsU, lazy: true, middleware: false, method: "get" },
  { route: '/api/customers/:id', handler: _lazy_W5I8nD, lazy: true, middleware: false, method: "put" },
  { route: '/api/customers', handler: _lazy_ZVGq17, lazy: true, middleware: false, method: "get" },
  { route: '/api/customers', handler: _lazy_BZDfmi, lazy: true, middleware: false, method: "post" },
  { route: '/api/dashboard', handler: _lazy_XwVgX7, lazy: true, middleware: false, method: "get" },
  { route: '/api/items/:id', handler: _lazy_A82byK, lazy: true, middleware: false, method: "delete" },
  { route: '/api/items/:id', handler: _lazy_Xu49Up, lazy: true, middleware: false, method: "get" },
  { route: '/api/items/:id', handler: _lazy_A5Q2pL, lazy: true, middleware: false, method: "put" },
  { route: '/api/items', handler: _lazy_6eoUUH, lazy: true, middleware: false, method: "get" },
  { route: '/api/items', handler: _lazy_xQOUCs, lazy: true, middleware: false, method: "post" },
  { route: '/api/purchases/:id', handler: _lazy_tLa308, lazy: true, middleware: false, method: "delete" },
  { route: '/api/purchases/:id', handler: _lazy_zH3jfg, lazy: true, middleware: false, method: "get" },
  { route: '/api/purchases/:id', handler: _lazy_0pov96, lazy: true, middleware: false, method: "put" },
  { route: '/api/purchases', handler: _lazy_fyGeCP, lazy: true, middleware: false, method: "get" },
  { route: '/api/purchases', handler: _lazy_MpbSxJ, lazy: true, middleware: false, method: "post" },
  { route: '/api/sales/:id', handler: _lazy_DWBXI3, lazy: true, middleware: false, method: "delete" },
  { route: '/api/sales/:id', handler: _lazy_fLL10b, lazy: true, middleware: false, method: "get" },
  { route: '/api/sales/:id', handler: _lazy_yKvwA6, lazy: true, middleware: false, method: "put" },
  { route: '/api/sales', handler: _lazy_pnLjai, lazy: true, middleware: false, method: "get" },
  { route: '/api/sales', handler: _lazy_1mZF5P, lazy: true, middleware: false, method: "post" },
  { route: '/api/vendors/:id', handler: _lazy_sJODlQ, lazy: true, middleware: false, method: "delete" },
  { route: '/api/vendors/:id', handler: _lazy_NRtoGq, lazy: true, middleware: false, method: "get" },
  { route: '/api/vendors/:id', handler: _lazy_AOEVW3, lazy: true, middleware: false, method: "put" },
  { route: '/api/vendors', handler: _lazy_prLOUD, lazy: true, middleware: false, method: "get" },
  { route: '/api/vendors', handler: _lazy_BjXgQf, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_xfiAXG, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_xfiAXG, lazy: true, middleware: false, method: undefined }
];
...
const _id__put$a = defineEventHandler(async (event) => {
  try {
    ...
    if (password) {
      await query(
        "UPDATE ADMIN SET username=?, password=?, fullname=?, status=? WHERE userid=?",
        [username, password, fullname, status, id]
      );
    } else {
      await query(
        "UPDATE ADMIN SET username=?, fullname=?, status=? WHERE userid=?",
...
const index_post$a = defineEventHandler(async (event) => {
  try {
    ...
    await query(
      "INSERT INTO ADMIN (userid, username, password, fullname, status) VALUES (?, ?, ?, ?, ?)",
...
const _id__put = defineEventHandler(async (event) => {
  try {
    ...
    await query(
      "UPDATE VENDOR SET name=?, address=?, mobile=?, email=? WHERE id=?",
...
const index_post = defineEventHandler(async (event) => {
  try {
    ...
    if (!id || !name || !mobile) return { success: false, message: "Missing required fields" };
    await query(
      "INSERT INTO VENDOR (id, name, address, mobile, email) VALUES (?, ?, ?, ?, ?)",
